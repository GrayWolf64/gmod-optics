if CLIENT then
  ...
  CreateClientConVar("Optics_Int_LaserEmitterMaxDetectionDistanceFront_CLIENT",128,false,true,"Maximum Distance in front of the laser emitter for detecting objects to interact with.")
  CreateClientConVar("Optics_Int_LaserEmitterMaxDetectionDistanceBack_CLIENT",128,false,true,"Maximum Distance behind the laser emitter for detecting objects to interact with.")
...
--[[
  render hooks used in the whole addon:
