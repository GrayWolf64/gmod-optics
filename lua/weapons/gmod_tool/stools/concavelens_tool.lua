 ...
 surface.CreateFont( "opticsdefaultfont", {
  ...
  outline = false,
    ...
    function TOOL.BuildCPanel(basepanel0)
      ...
      local basepanel1 = vgui.Create("DPanel", basepanel0)
      basepanel1:SetSize(200*monitor_ratiow, 400*monitor_ratioh)
      basepanel1:DockMargin(10*monitor_ratiow, 10*monitor_ratioh, 10*monitor_ratiow, 10*monitor_ratioh)
      basepanel1:Dock(TOP)

      local desc0 = vgui.Create( "DLabel", basepanel1)
      desc0:SetColor(Color(190, 190, 190))
      desc0:SetText( "Model Selection" )
      ...
      collapsible0_content1:SetText("Test")
      collapsible0_content1:SetTextColor( Color(0 ,0 ,0) )
      ...
      collapsible0_content2:SetText("Test")
      collapsible0_content2:SetDark( true )
      collapsible0_content2:SetMin(0)
      collapsible0_content2:SetMax(100)
