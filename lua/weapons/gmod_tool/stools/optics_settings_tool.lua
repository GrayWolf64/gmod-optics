...
if CLIENT then
    ...
    function TOOL:Think()
        ...
        if thing:IsValid() == true and self:GetOwner():GetActiveWeapon():GetClass() == "gmod_tool" and thing:GetClass() == "optics_concavelens" and GetConVar("Optics_Bool_GeneralSettingsToolDrawDebugLines_CLIENT"):GetBool() == true then
            ...
            hook.Add("PostDrawTranslucentRenderables", "Optics_DebugRenderables02", function()
                if thing:IsValid() == true then
